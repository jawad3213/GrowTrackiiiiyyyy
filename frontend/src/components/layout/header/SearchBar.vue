    ...
    <form>
      <div class="relative">
        ...
        <input
          ...
          class="dark:bg-dark-900 h-11 w-[400px] rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400
