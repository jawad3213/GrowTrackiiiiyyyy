...
<!--<div class="text-center">
    <h2 class="text-3xl font-bold">
      ...
      <span v-else>{{ totalUsers.toLocaleString() }}</span>
    </h2>
  </div>
  -->
...
onMounted(async () => {
  try {
    const response = await axios.post('http://localhost:5000/DashAdmin/Total_User')
    totalUsers.value = response.data.total_users  // adapte cette clé selon ta réponse
  } catch (error) {
