<template>
  <div>
    ...
    <Modal v-if="isProfileInfoModal" @close="isProfileInfoModal = false">
      <template #body>
        <div
          class="no-scrollbar relative w-full max-w-[700px] max-h-[400px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11"
        >
          <!-- close btn -->
          <button
        ...
        <div class="flex items-center gap-3 px-2 mt-0 lg:justify-end">
          <!-- Save Changes Button -->
            <button
              @click="saveProfile"
              type="button"
