        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">Soukaina</p>
            </div>
            ...
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">+212 77616 5966</p>
            </div>
            ...
            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">CIN</p>
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">XXXXXX</p>
            </div>

            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Authority</p>
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">Manage and approve signals and evaluations/Manage users </p>
            </div>
