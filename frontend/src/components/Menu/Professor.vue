    ...
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
      ...
      <main class="flex-1 flex flex-col">
                ...
                <td class="py-3 px-4 text-gray-800 dark:text-gray-100">
                  <div class="flex items-center space-x-3">
                    <div
                      ...
                      :style="{ backgroundColor: stringToColor(prof.full_name) }"
                    >
        ...
        >
          ...
          <p class="mb-6">
            You haven’t added any professors yet.
          </p>
          <router-link to="/AddProfessor">
            <button
...
/**
 * Generate a reproducible HSL color from a string (prof name).
 */
