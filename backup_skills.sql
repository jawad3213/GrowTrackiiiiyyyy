...
23	\N	c3e78aec-53f6-4b16-8138-69bdf55b663a	75	Groupe 4
...
SELECT pg_catalog.setval('public.news_id_news_seq', 41, true);
...
SELECT pg_catalog.setval('public.project_id_project_seq', 83, true);
...
SELECT pg_catalog.setval('public.signal_id_signal_seq', 20, true);
...
SELECT pg_catalog.setval('public.skill_evaluation_id_evaluation_seq', 31, true);
...
SELECT pg_catalog.setval('public.team_id_team_seq', 24, true);
